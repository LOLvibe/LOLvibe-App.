...
#define kStoredObjectKey    @"storeNesetChatAppObject"
#define APP_KEY_STR         (@"nesetchat" @"app")
#define kKeychainService    @"com.app.nesetchat"
...
+(BOOL)boolStringForKey:(NSString *)key
{
    ...
    value = [NKeyChain objectForKey:key];
